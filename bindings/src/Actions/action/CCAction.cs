namespace Urho
{
    ...
    public abstract class CCAction
    {
        ...
        protected internal virtual CCActionState StartAction (Node target)
        {
            return null;
    ...
    public abstract class CCActionState
    {
        ...
        //protected UrhoObject Layer { get; private set; }
        ...
        public CCActionState (CCAction action, Node target)
        {
            this.Action = action;
            this.Target = target;
