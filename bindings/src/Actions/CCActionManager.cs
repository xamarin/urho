...
namespace Urho
{
    public class CCActionManager : IDisposable
    {
        ...
        public CCAction GetAction(int tag, Node target)
        {
        ...
        public CCActionState GetActionState(int tag, Node target)
        {
            Debug.Assert(tag != (int)CCActionTag.Invalid);
        ...
        public CCActionState AddAction(CCAction action, Node target, bool paused = false)
        {
        ...
        internal void RemoveAction(CCAction action, Node target)
        {
