...
namespace SharpieBinder
{
	class CxxBinder : AstVisitor
	{
		...
		public CxxBinder(string outputDir)
		{
			...
			podStream.WriteLine ("// Autogenerated, do not edit");
			podStream.WriteLine ("using System;");
			podStream.WriteLine ("using System.Runtime.InteropServices;");
			podStream.WriteLine ("namespace Urho {");
		...
		{
			return p.Replace ("<", "_").Replace (">", "").Replace (" ", "").Replace ("::", "__").Replace("*","Ptr").Replace ("classUrho3D_", "");
		}

		void GeneratePodVector ()
		{
			var ps = podStream;
			ps.WriteLine ("\tinternal class PodVectorHelper {");
			...
			ps.WriteLine ("\t}\n}");
			foreach (var p in missingPodClasses)
				Console.WriteLine ("PodClassMissing: {0}", p);
		}
		...
		static Dictionary<string, string> typeNamespaces = new Dictionary<string, string>()
		{
			...
			{ "CheckBox", "Urho.UI" }, 
			{ "Cursor", "Urho.UI" }, 
			{ "DropDownList", "Urho.UI" }, 
			{ "FileSelector", "Urho.UI" }, 
			{ "Font", "Urho.UI" }, 
			{ "FontFace", "Urho.UI" }, 
			{ "FontFaceBitmap", "Urho.UI" }, 
			{ "FontFaceFreeType", "Urho.UI" }, 
			{ "LineEdit", "Urho.UI" }, 
			{ "ListView", "Urho.UI" }, 
			{ "Menu", "Urho.UI" }, 
			{ "MessageBox", "Urho.UI" }, 
			...
			{ "CursorShape", "Urho.UI" },
			//{ "FONT_TYPE", "Urho.UI" },
			{ "HighlightMode", "Urho.UI" },
			{ "TextEffect", "Urho.UI" },
			{ "HorizontalAlignment", "Urho.UI" },
			{ "VerticalAlignment", "Urho.UI" },
			{ "Corner", "Urho.UI" },
			{ "Orientation", "Urho.UI" },
			{ "FocusMode", "Urho.UI" },
			{ "LayoutMode", "Urho.UI" },
			{ "TraversalMode", "Urho.UI" },
			{ "WindowDragMode", "Urho.UI" },
		...
		void PushType(TypeDeclaration typeDeclaration, IEnumerable<string> comments)
		{
			...
			syntaxTree.Members.Add(new UsingDeclaration() { Import = new SimpleType("Urho.UI") });
