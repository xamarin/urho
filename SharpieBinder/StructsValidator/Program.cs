...
namespace StructsValidator
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			if (IntPtr.Size == 8)
				AppendC("#if defined(_WIN64) || defined(__x86_64__) || defined(__ppc64__) // generated for x64 only\n");
			else
				AppendC("#if !defined(_WIN64) && !defined(__x86_64__) && !defined(__ppc64__) // generated for x86 only\n");
