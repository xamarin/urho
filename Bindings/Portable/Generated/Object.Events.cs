...
namespace Urho {
        public partial struct ScreenModeEventArgs {
            ...
            public int Monitor => UrhoMap.get_int (handle, UrhoHash.P_MONITOR);
            public int RefreshRate => UrhoMap.get_int (handle, UrhoHash.P_REFRESHRATE);
...
namespace Urho {
        public partial struct IKEffectorTargetChangedEventArgs {
            internal IntPtr handle;
            public Node EffectorNode => UrhoMap.get_Node (handle, UrhoHash.P_EFFECTORNODE);
            public Node TargetNode => UrhoMap.get_Node (handle, UrhoHash.P_TARGETNODE);
...
namespace Urho {
        public partial struct TextEditingEventArgs {
            internal IntPtr handle;
            public String Composition => UrhoMap.get_String (handle, UrhoHash.P_COMPOSITION);
            public int Cursor => UrhoMap.get_int (handle, UrhoHash.P_CURSOR);
            public int SelectionLength => UrhoMap.get_int (handle, UrhoHash.P_SELECTION_LENGTH);
...
namespace Urho.Gui {
        ...
        public partial class LineEdit {
             ObjectCallbackSignature callbackTextEntry;
             [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
             extern static IntPtr urho_subscribe_TextEntry (IntPtr target, ObjectCallbackSignature act, IntPtr data);
             public Subscription SubscribeToTextEntry (Action<TextEntryEventArgs> handler)
             {
                  Action<IntPtr> proxy = (x)=> { var d = new TextEntryEventArgs () { handle = x }; handler (d); };
                  var s = new Subscription (proxy);
                  callbackTextEntry = ObjectCallback;
                  s.UnmanagedProxy = urho_subscribe_TextEntry (handle, callbackTextEntry, GCHandle.ToIntPtr (s.gch));
                  return s;
             }
             ...
             public event Action<TextEntryEventArgs> TextEntry
             {
                 add
                 {
                      if (eventAdapterForTextEntry == null)
                          eventAdapterForTextEntry = new UrhoEventAdapter<TextEntryEventArgs>();
...
namespace Urho {
        public partial struct PhysicsUpdateContact2DEventArgs {
            ...
            public CollisionData [] ContactPoints => UrhoMap.get_CollisionData (handle, UrhoHash.P_CONTACTPOINTS);
            public CollisionShape2D ShapeA => UrhoMap.get_CollisionShape2D (handle, UrhoHash.P_SHAPEA);
            public CollisionShape2D ShapeB => UrhoMap.get_CollisionShape2D (handle, UrhoHash.P_SHAPEB);
            public bool Enabled => UrhoMap.get_bool (handle, UrhoHash.P_ENABLED);
...
namespace Urho {
        public partial struct NodeUpdateContact2DEventArgs {
            ...
            public IntPtr Contact => UrhoMap.get_IntPtr (handle, UrhoHash.P_CONTACT);
            public CollisionData [] ContactPoints => UrhoMap.get_CollisionData (handle, UrhoHash.P_CONTACTPOINTS);
            public CollisionShape2D Shape => UrhoMap.get_CollisionShape2D (handle, UrhoHash.P_SHAPE);
            public CollisionShape2D OtherShape => UrhoMap.get_CollisionShape2D (handle, UrhoHash.P_OTHERSHAPE);
            public bool Enabled => UrhoMap.get_bool (handle, UrhoHash.P_ENABLED);
...
namespace Urho {
        public partial struct ParticlesEndEventArgs {
            internal IntPtr handle;
            public Node Node => UrhoMap.get_Node (handle, UrhoHash.P_NODE);
            public ParticleEffect2D Effect => UrhoMap.get_ParticleEffect2D (handle, UrhoHash.P_EFFECT);
...
namespace Urho {    internal class UrhoHash {
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_TARGETNODE ();
            static int _P_TARGETNODE;
            internal static int P_TARGETNODE { get { if (_P_TARGETNODE == 0){ _P_TARGETNODE = urho_hash_get_P_TARGETNODE (); } return _P_TARGETNODE; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_MONITOR ();
            static int _P_MONITOR;
            internal static int P_MONITOR { get { if (_P_MONITOR == 0){ _P_MONITOR = urho_hash_get_P_MONITOR (); } return _P_MONITOR; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_SHAPEB ();
            static int _P_SHAPEB;
            internal static int P_SHAPEB { get { if (_P_SHAPEB == 0){ _P_SHAPEB = urho_hash_get_P_SHAPEB (); } return _P_SHAPEB; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_OTHERSHAPE ();
            static int _P_OTHERSHAPE;
            internal static int P_OTHERSHAPE { get { if (_P_OTHERSHAPE == 0){ _P_OTHERSHAPE = urho_hash_get_P_OTHERSHAPE (); } return _P_OTHERSHAPE; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_ENABLED ();
            static int _P_ENABLED;
            internal static int P_ENABLED { get { if (_P_ENABLED == 0){ _P_ENABLED = urho_hash_get_P_ENABLED (); } return _P_ENABLED; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_SHAPEA ();
            static int _P_SHAPEA;
            internal static int P_SHAPEA { get { if (_P_SHAPEA == 0){ _P_SHAPEA = urho_hash_get_P_SHAPEA (); } return _P_SHAPEA; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_COMPOSITION ();
            static int _P_COMPOSITION;
            ...
            static int _P_CURSOR;
            internal static int P_CURSOR { get { if (_P_CURSOR == 0){ _P_CURSOR = urho_hash_get_P_CURSOR (); } return _P_CURSOR; }}

            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_EFFECTORNODE ();
            static int _P_EFFECTORNODE;
            internal static int P_EFFECTORNODE { get { if (_P_EFFECTORNODE == 0){ _P_EFFECTORNODE = urho_hash_get_P_EFFECTORNODE (); } return _P_EFFECTORNODE; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_CONTACTPOINTS ();
            static int _P_CONTACTPOINTS;
            internal static int P_CONTACTPOINTS { get { if (_P_CONTACTPOINTS == 0){ _P_CONTACTPOINTS = urho_hash_get_P_CONTACTPOINTS (); } return _P_CONTACTPOINTS; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_SHAPE ();
            static int _P_SHAPE;
            internal static int P_SHAPE { get { if (_P_SHAPE == 0){ _P_SHAPE = urho_hash_get_P_SHAPE (); } return _P_SHAPE; }}
            ...
            [DllImport(Consts.NativeImport, CallingConvention=CallingConvention.Cdecl)]
            extern static int urho_hash_get_P_REFRESHRATE ();
            static int _P_REFRESHRATE;
            internal static int P_REFRESHRATE { get { if (_P_REFRESHRATE == 0){ _P_REFRESHRATE = urho_hash_get_P_REFRESHRATE (); } return _P_REFRESHRATE; }}
