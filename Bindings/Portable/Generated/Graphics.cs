...
namespace Urho
{
	...
	public unsafe partial class Graphics : UrhoObject
	{
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern IntVector2 Graphics_GetSize (IntPtr handle);
		...
		[DllImport (Consts.NativeImport, CallingConvention = CallingConvention.Cdecl)]
		internal static extern IntVector2 Graphics_GetDesktopResolution (IntPtr handle, int monitor);

		/// <summary>
		/// Return the desktop resolution.
		/// </summary>
		public IntVector2 GetDesktopResolution (int monitor)
		{
			Runtime.ValidateRefCounted (this);
