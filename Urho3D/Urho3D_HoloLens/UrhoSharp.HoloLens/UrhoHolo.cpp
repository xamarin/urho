...
extern "C" __declspec(dllexport) void InitializeSpace()
{
	SDL_SetMainReady();
...
extern "C" __declspec(dllexport) void Camera_SetProjection(Camera* camera, const class Matrix4& view, const class Matrix4& projection)
{
